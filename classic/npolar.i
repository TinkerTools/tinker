...
c     #############################################################
c     ##                                                         ##
c     ##  npolar.i  --  nonpolar cavity & dispersion parameters  ##
c     ##                                                         ##
c     #############################################################
c
c
...
c
      ...
      real*8 spcut,spoff
      real*8 stcut,stoff
      real*8 rcav,rdisp,cdisp
      common /npolar/ solvprs,surften,spcut,spoff,stcut,stoff,
     &                rcav(maxatm),rdisp(maxatm),cdisp(maxatm)
