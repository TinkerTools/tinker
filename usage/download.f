...
c
   ...
   40    format (a256)
         ...
         iload1 = max(iload1,index(record,'tinker-5.1.01.tar.gz'))
         iload1 = max(iload1,index(record,'tinker-5.1.02.tar.gz'))
         iload1 = max(iload1,index(record,'tinker-5.1.03.tar.gz'))
         iload1 = max(iload1,index(record,'tinker-5.1.04.tar.gz'))
         iload2 = index(record,'tinker.zip')
         iload2 = max(iload2,index(record,'tinker-5.1.01.zip'))
         iload2 = max(iload2,index(record,'tinker-5.1.02.zip'))
         iload2 = max(iload2,index(record,'tinker-5.1.03.zip'))
         iload2 = max(iload2,index(record,'tinker-5.1.04.zip'))
