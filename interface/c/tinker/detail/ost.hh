...
extern int TINKER_MOD(ost, ostnpa);
extern int TINKER_MOD(ost, ostnpb);
extern int TINKER_MOD(ost, ostnpc);
...
extern int* TINKER_MOD(ost, ostihist);
...
extern double TINKER_MOD(ost, ostbvbias);
...
extern double TINKER_MOD(ost, ostparatio);
extern double TINKER_MOD(ost, ostpbratio);
extern double TINKER_MOD(ost, ostpcratio);
extern double TINKER_MOD(ost, oststdev);
extern double TINKER_MOD(ost, osttheta);
extern double TINKER_MOD(ost, ostvtheta);
extern double TINKER_MOD(ost, tempergamma);
extern double TINKER_MOD(ost, temperthresh);
