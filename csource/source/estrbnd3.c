/* estrbnd3.f -- translated by f2c (version 20050501).
...
/* Subroutine */ int estrbnd3_(void)
{
    /* Format strings */
    static char fmt_10[] = "(/,\002 Individual Stretch-Bend\002,\002 Interac"
	    "tions :\002,//,\002 Type\002,17x,\002Atom Names\002,16x,\002dSB 1"
	    "\002,5x,\002dSB 2\002,6x,\002Energy\002,/)";
    static char fmt_20[] = "(\002 StrBend\002,4x,i5,\002-\002,a3,1x,i5,\002"
	    "-\002,a3,1x,i5,\002-\002,a3,2x,2f10.4,f12.4)";
    ...
    static doublereal dt, dr1, dr2, dot, xia, yia, zia, xib, yib, zib, xic, 
	    yic, zic, xab, yab, zab, xcb, ycb, zcb, rab, rcb, rab2, rcb2, 
	    fgrp;
    static logical huge__;
    extern /* Subroutine */ int image_(doublereal *, doublereal *, doublereal 
	    *);
    static doublereal angle, force1, force2;
