/* optirot.f -- translated by f2c (version 20050501).
...
/*     ################################################################ */
/*     ##                                                            ## */
/*     ##  program optirot  --  variable metric torsional optimizer  ## */
/*     ##                                                            ## */
/*     ################################################################ */
...
{
    /* Format strings */
    static char fmt_10[] = "(/,\002 OPTIROT  --  Too many Parameters,\002"
	    ",\002 Increase the Value of MAXOPT\002)";
    static char fmt_40[] = "(/,\002 Enter RMS Gradient per Torsion Criterio"
	    "n\002,\002 [0.01] :  \002,$)";
...
/*     make the call to the optimization routine */
    ...
    ocvm_(&omega_1.nomega, xx, &minimum, &grdmin, (D_fp)optirot1_, (U_fp)
	    optsave_);
...
/*     ############################################################## */
/*     ##                                                          ## */
/*     ##  function optirot1  --  energy and gradient for optirot  ## */
/*     ##                                                          ## */
/*     ############################################################## */
...
doublereal optirot1_(doublereal *xx, doublereal *g)
{
    /* System generated locals */
    integer i__1;
    doublereal ret_val;
...
/* Main program alias */ int optirot_ () { MAIN__ (); return 0; }
