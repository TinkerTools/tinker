/* ehal1.f -- translated by f2c (version 20050501).
...
/* Subroutine */ int ehal1_(void)
{
    static doublereal elrc, vlrc;
    extern /* Subroutine */ int ehal1a_(void), ehal1b_(void), ehal1c_(void), 
	    evcorr1_(doublereal *, doublereal *);
...
/*     ################################################################# */
/*     ##                                                             ## */
/*     ##  subroutine ehal1a  --  double loop buffer 14-7 vdw derivs  ## */
/*     ##                                                             ## */
/*     ################################################################# */
...
/* Subroutine */ int ehal1a_(void)
{
    ...
    static doublereal rdn, rik, eps, rho, tau, vxx, vyx, vyy, vzx, vzz, vzy, 
	    rik2, rik3, rik4, rik5, rik6, rik7, tau7, redi, redk, dedx, dedy, 
	    dedz, fgrp, dtau, gtau, xred[25000], yred[25000], zred[25000];
    static logical usei;
...
/* Computing 2nd power */
			...
			gtau = eps * tau7 * rik6 * (vdwpot_1.ghal + 1.) * (
				d__1 * d__1);
			e = eps * tau7 * rv7 * ((vdwpot_1.ghal + 1.) * rv7 / 
				rho - 2.);
			de = (dtau * e + gtau) * -7.;
...
/*     ################################################################## */
/*     ##                                                              ## */
/*     ##  subroutine ehal1b  --  buffered 14-7 vdw derivs via lights  ## */
/*     ##                                                              ## */
/*     ################################################################## */
...
/* Subroutine */ int ehal1b_(void)
{
    ...
    static doublereal eps, rdn, rho, tau, rik, vxx, vyx, vyy, vzx, vzz, vzy, 
	    rik2, rik3, rik4, rik5, rik6, rik7, tau7, redi, redk, dedx, dedy, 
	    fgrp;
    static integer stop;
    static doublereal dedz, dtau, gtau, xred[25000], yred[25000], zred[25000];
    static logical usei;
    static doublereal rediv, redkv, taper;
