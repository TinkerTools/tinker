/* epitors3.f -- translated by f2c (version 20050501).
...
/* Subroutine */ int epitors3_(void)
{
    /* Format strings */
    static char fmt_10[] = "(/,\002 Individual Pi-Orbital Torsion\002,\002 I"
	    "nteractions :\002,//,\002 Type\002,13x,\002Atom Names\002,30x"
	    ",\002Angle\002,6x,\002Energy\002,/)";
    static char fmt_20[] = "(\002 PiTors\002,5x,i5,\002-\002,a3,1x,i5,\002"
	    "-\002,a3,22x,f10.4,f12.4)";
    ...
    static doublereal xt, yt, zt, xu, yu, zu, rt2, ru2, rdc, xia, yia, zia, 
	    ...
	    yig, xtu, ytu, ztu, zig, xip, yip, zip, xiq, yiq, ziq, xad, yad, 
	    zad, xbd, ybd, zbd, xec, phi2, yec, zec, xgc, ygc, zgc, xcp, ycp, 
	    zcp, xdc, ydc, zdc, xqd, yqd, zqd;
    static logical huge__;
    static doublereal fgrp, sine, rtru, sine2;
    ...
    /* Fortran I/O blocks */
    static cilist io___80 = { 0, 0, 0, fmt_10, 0 };
    static cilist io___81 = { 0, 0, 0, fmt_20, 0 };
...
/*     increment the total pi-orbital torsion angle energy */
		...
		++action_1.nept;
		energi_1.ept += e;
		analyz_1.aept[ic - 1] += e * .5;
		analyz_1.aept[id - 1] += e * .5;
