/* eimptor2.f -- translated by f2c (version 20050501).
...
/*     ############################################################### */
/*     ##                                                           ## */
/*     ##  subroutine eimptor2  --  atomwise impr. torsion Hessian  ## */
/*     ##                                                           ## */
/*     ############################################################### */
...
/* Subroutine */ int eimptor2_(integer *i__)
{
    ...
    static doublereal dxiazid, dyiaxid, dyiayid, dyiazid, dziaxid, dziayid, 
	    ...
	    c2, c3, dphidxibt, dphidyibt, dphidzibt, dphidxibu, dphidyibu, 
	    dphidzibu, s1, s2, s3, v1, v2, v3, dphidxict, dphidyict, 
	    dphidzict, dphidxicu, dphidyicu, dphidzicu;
    ...
    static doublereal xt, yt, zt, xu, yu, zu, rt2, ru2, rcb, xba, yba, zba, 
	    ...
	    ztu, fgrp, sine, rtru, dphi1, dphi2, dphi3, rcbt2, rcbu2, sine2, 
	    sine3, xycb2, xzcb2, yzcb2;
    extern /* Subroutine */ int image_(doublereal *, doublereal *, doublereal 
	    *);
    static doublereal d2phi1, d2phi2, d2phi3, rcbxt, rcbyt, rcbzt, rcbxu, 
	    rcbyu, rcbzu, dedphi, cosine;
    static integer kitors;
    extern /* Subroutine */ int groups_(logical *, doublereal *, integer *, 
	    integer *, integer *, integer *, integer *, integer *);
    static doublereal cosine2, cosine3, d2edphi2;
...
/*     compute Hessian elements for the improper torsional angles */

    i__1 = imptor_1.nitors;
    for (kitors = 1; kitors <= i__1; ++kitors) {
	ia = iitors_ref(1, kitors);
	ib = iitors_ref(2, kitors);
	ic = iitors_ref(3, kitors);
	id = iitors_ref(4, kitors);
...
/*     set the improper torsional parameters for this angle */
		...
		v1 = itors1_ref(1, kitors);
		c1 = itors1_ref(3, kitors);
		s1 = itors1_ref(4, kitors);
		v2 = itors2_ref(1, kitors);
		c2 = itors2_ref(3, kitors);
		s2 = itors2_ref(4, kitors);
		v3 = itors3_ref(1, kitors);
		c3 = itors3_ref(3, kitors);
		s3 = itors3_ref(4, kitors);
...
/*     calculate the improper torsion master chain rule terms */
		...
		dedphi = torpot_1.itorunit * (v1 * dphi1 + v2 * dphi2 + v3 * 
			dphi3);
		d2edphi2 = torpot_1.itorunit * (v1 * d2phi1 + v2 * d2phi2 + 
			v3 * d2phi3);
