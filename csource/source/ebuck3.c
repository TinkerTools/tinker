/* ebuck3.f -- translated by f2c (version 20050501).
...
/*     ############################################################### */
/*     ##                                                           ## */
/*     ##  subroutine ebuck3  --  Buckingham vdw energy & analysis  ## */
/*     ##                                                           ## */
/*     ############################################################### */
...
/* Subroutine */ int ebuck3_(void)
{
    /* Format strings */
    static char fmt_10[] = "(/,\002 EBUCK3  --  Stophat Smoothing not Availa"
	    "ble\002,\002 for Buckingham vdw Potential\002)";
    static char fmt_20[] = "(/,\002 Long Range vdw Correction :\002,9x,f12.4)"
	    ;
    ...
    extern /* Subroutine */ int fatal_(void), ebuck3b_(void), ebuck3c_(void), 
	    ebuck3d_(void), ebuck3a_(void), evcorr_(doublereal *);
...
/*     ############################################################### */
/*     ##                                                           ## */
/*     ##  subroutine ebuck3a  --  double loop Buckingham analysis  ## */
/*     ##                                                           ## */
/*     ############################################################### */
...
/* Subroutine */ int ebuck3a_(void)
{
    ...
    static char fmt_20[] = "(\002 VDW-Buck\002,3x,i5,\002-\002,a3,1x,i5"
	    ",\002-\002,a3,12x,2f10.4,f12.4)";
    static char fmt_30[] = "(/,\002 Individual van der Waals\002,\002 Intera"
	    "ctions :\002,//,\002 Type\002,13x,\002Atom Names\002,18x,\002Min"
	    "imum\002,4x,\002Actual\002,6x,\002Energy\002,/)";
    static char fmt_40[] = "(\002 VDW-Buck\002,3x,i5,\002-\002,a3,1x,i5"
	    ",\002-\002,a3,3x,\002(XTAL)\002,3x,2f10.4,f12.4)";
    ...
    extern /* Subroutine */ int imager_(doublereal *, doublereal *, 
	    doublereal *, integer *);
    static doublereal vscale[25000], expcut;
    extern /* Subroutine */ int switch_(char *, ftnlen), groups_(logical *, 
	    doublereal *, integer *, integer *, integer *, integer *, integer 
	    *, integer *);
    static doublereal expcut2;
    static logical proceed;
    static doublereal expterm;

    /* Fortran I/O blocks */
    static cilist io___49 = { 0, 0, 0, fmt_10, 0 };
...
/*     ############################################################## */
/*     ##                                                          ## */
/*     ##  subroutine ebuck3b  --  Buckingham analysis via lights  ## */
/*     ##                                                          ## */
/*     ############################################################## */
...
/* Subroutine */ int ebuck3b_(void)
{
    /* Format strings */
    static char fmt_20[] = "(/,\002 Individual van der Waals\002,\002 Intera"
	    "ctions :\002,//,\002 Type\002,13x,\002Atom Names\002,18x,\002Min"
	    "imum\002,4x,\002Actual\002,6x,\002Energy\002,/)";
    static char fmt_30[] = "(\002 VDW-Buck\002,3x,i5,\002-\002,a3,1x,i5"
	    ",\002-\002,a3,12x,2f10.4,f12.4)";
    static char fmt_40[] = "(\002 VDW-Buck\002,3x,i5,\002-\002,a3,1x,i5"
	    ",\002-\002,a3,3x,\002(XTAL)\002,3x,2f10.4,f12.4)";
...
/*     ############################################################ */
/*     ##                                                        ## */
/*     ##  subroutine ebuck3c  --  Buckingham analysis via list  ## */
/*     ##                                                        ## */
/*     ############################################################ */
...
/*     ################################################################# */
/*     ##                                                             ## */
/*     ##  subroutine ebuck3d  --  Buckingham analysis for smoothing  ## */
/*     ##                                                             ## */
/*     ################################################################# */
