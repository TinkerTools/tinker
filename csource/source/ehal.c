/* ehal.f -- translated by f2c (version 20050501).
...
/*     ############################################################### */
/*     ##                                                           ## */
/*     ##  subroutine ehal  --  buffered 14-7 van der Waals energy  ## */
/*     ##                                                           ## */
/*     ############################################################### */
...
/* Subroutine */ int ehal_(void)
{
    static doublereal elrc;
    extern /* Subroutine */ int ehal0a_(void), ehal0b_(void), ehal0c_(void), 
	    evcorr_(doublereal *);
...
/*     ################################################################ */
/*     ##                                                            ## */
/*     ##  subroutine ehal0a  --  buffered 14-7 vdw via double loop  ## */
/*     ##                                                            ## */
/*     ################################################################ */
...
/* Subroutine */ int ehal0a_(void)
{
    ...
    static doublereal xi, yi, zi, rv, xr, yr, zr, rv7;
    static integer iv14[25000];
    static doublereal rdn, rik, eps, rho, tau, rik2, rik3, rik4, rik5, rik7, 
	    fgrp, xred[25000], yred[25000], zred[25000];
    static logical usei;
...
/* Computing 7th power */
			d__1 = tau, d__2 = d__1, d__1 *= d__1, d__2 *= d__1;
			e = eps * rv7 * (d__2 * (d__1 * d__1)) * ((
				vdwpot_1.ghal + 1.) * rv7 / rho - 2.);
...
/*     ################################################################## */
/*     ##                                                              ## */
/*     ##  subroutine ehal0b  --  buffered 14-7 vdw energy via lights  ## */
/*     ##                                                              ## */
/*     ################################################################## */
...
/* Subroutine */ int ehal0b_(void)
{
    ...
    static doublereal eps, rdn, rho, tau, rik, rik2, rik3, rik4, rik5, rik7, 
	    fgrp, xred[25000], yred[25000];
    static integer stop;
...
/*     ################################################################ */
/*     ##                                                            ## */
/*     ##  subroutine ehal0c  --  buffered 14-7 vdw energy via list  ## */
/*     ##                                                            ## */
/*     ################################################################ */
