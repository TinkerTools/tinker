/* eurey3.f -- translated by f2c (version 20050501).
...
/* Subroutine */ int eurey3_(void)
{
    /* Format strings */
    static char fmt_10[] = "(/,\002 Individual Urey-Bradley Interactions "
	    ":\002,//,\002 Type\002,17x,\002Atom Names\002,16x,\002Ideal\002,"
	    "4x,\002Actual\002,6x,\002Energy\002,/)";
    static char fmt_20[] = "(\002 UreyBrad\002,3x,i5,\002-\002,a3,1x,i5"
    ...
    static doublereal dt, dt2, xac, yac, zac, rac;
    ...
    /* Fortran I/O blocks */
    static cilist io___18 = { 0, 0, 0, fmt_10, 0 };
...
/*     increment the total Urey-Bradley energy */
	    ...
	    ++action_1.neub;
	    energi_1.eub += e;
	    analyz_1.aeub[ia - 1] += e * .5;
	    analyz_1.aeub[ic - 1] += e * .5;
...
/*     print a message if the energy of this interaction is large */
		...
		do_fio(&c__1, (char *)&rac, (ftnlen)sizeof(doublereal));
