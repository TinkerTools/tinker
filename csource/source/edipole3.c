/* edipole3.f -- translated by f2c (version 20050501).
...
/*     ################################################################ */
/*     ##                                                            ## */
/*     ##  subroutine edipole3  --  dipole-dipole energy & analysis  ## */
/*     ##                                                            ## */
/*     ################################################################ */
...
/* Subroutine */ int edipole3_(void)
{
    /* Format strings */
    static char fmt_10[] = "(/,\002 Individual Dipole-Dipole\002,\002 Intera"
	    "ctions :\002,//,\002 Type\002,14x,\002Dipole 1\002,14x,\002Dipol"
	    "e 2\002,6x,\002Distance\002,6x,\002Energy\002,/)";
    static char fmt_20[] = "(\002 Dipole\002,5x,i5,\002-\002,a3,1x,i5,\002"
	    "-\002,a3,\002 / \002,i5,\002-\002,a3,1x,i5,\002-\002,a3,f10.4,f1"
	    "2.4)";
    static char fmt_30[] = "(/,\002 Individual Dipole-Dipole\002,\002 Intera"
	    "ctions :\002,//,\002 Type\002,14x,\002Dipole 1\002,14x,\002Dipol"
	    "e 2\002,6x,\002Distance\002,6x,\002Energy\002,/)";
    static char fmt_40[] = "(\002 Dipole\002,5x,i5,\002-\002,a3,1x,i5,\002"
	    "-\002,a3,\002 / \002,i5,\002-\002,a3,1x,i5,\002-\002,a3,f10.4,f1"
	    "2.4)";
...
/*     zero out the overall dipole interaction energy contribution */
...
/*     compute and partition the dipole interaction energy */
...
/*     increment the overall dipole-dipole energy component */
		    ...
		    ++action_1.ned;
		    energi_1.ed += e;
		    analyz_1.aed[i1 - 1] += e * .25;
		    analyz_1.aed[i2 - 1] += e * .25;
		    analyz_1.aed[k1 - 1] += e * .25;
		    analyz_1.aed[k2 - 1] += e * .25;
...
/*     print a message if the energy of this interaction is large */
			...
			do_fio(&c__1, name___ref(0, i2), (ftnlen)3);
