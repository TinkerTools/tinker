/* egauss3.f -- translated by f2c (version 20050501).
...
/*     ############################################################## */
/*     ##                                                          ## */
/*     ##  subroutine egauss3  --  Gaussian vdw energy & analysis  ## */
/*     ##                                                          ## */
/*     ############################################################## */
...
/* Subroutine */ int egauss3_(void)
{
    extern /* Subroutine */ int egauss3a_(void), egauss3b_(void), egauss3c_(
	    void), egauss3d_(void);
...
/*     ################################################################## */
/*     ##                                                              ## */
/*     ##  subroutine egauss3a  --  double loop Gaussian vdw analysis  ## */
/*     ##                                                              ## */
/*     ################################################################## */
...
/* Subroutine */ int egauss3a_(void)
{
    ...
    static char fmt_20[] = "(\002 VDW-Gauss\002,2x,i5,\002-\002,a3,1x,i5,"
	    "\002-\002,a3,12x,2f10.4,f12.4)";
    static char fmt_30[] = "(/,\002 Individual van der Waals\002,\002 Intera"
	    "ctions :\002,//,\002 Type\002,13x,\002Atom Names\002,18x,\002Min"
	    "imum\002,4x,\002Actual\002,6x,\002Energy\002,/)";
    static char fmt_40[] = "(\002 VDW-Gauss\002,2x,i5,\002-\002,a3,1x,i5,"
    ...
    static doublereal eps, rdn, rad, rik, rad2, rik2, rik3, rik4, rik5;
...
/*     increment the total van der Waals energy components */
...
/*     print a message if the energy of this interaction is large */
			...
			if (inform_1.debug && e != 0. || inform_1.verbose && 
			    ...
			    do_fio(&c__1, (char *)&k, (ftnlen)sizeof(integer))
				    ;
			    do_fio(&c__1, name___ref(0, k), (ftnlen)3);
			    do_fio(&c__1, (char *)&rad, (ftnlen)sizeof(
				    doublereal));
			    d__1 = sqrt(rik2);
			    do_fio(&c__1, (char *)&d__1, (ftnlen)sizeof(
				    doublereal));
...
/*     ################################################################# */
/*     ##                                                             ## */
/*     ##  subroutine egauss3b  --  Gaussian vdw analysis via lights  ## */
/*     ##                                                             ## */
/*     ################################################################# */
...
/* Subroutine */ int egauss3b_(void)
{
    /* Format strings */
    static char fmt_20[] = "(/,\002 Individual van der Waals\002,\002 Intera"
	    "ctions :\002,//,\002 Type\002,13x,\002Atom Names\002,18x,\002Min"
	    "imum\002,4x,\002Actual\002,6x,\002Energy\002,/)";
    static char fmt_30[] = "(\002 VDW-Gauss\002,2x,i5,\002-\002,a3,1x,i5,"
	    "\002-\002,a3,12x,2f10.4,f12.4)";
    static char fmt_40[] = "(\002 VDW-Gauss\002,2x,i5,\002-\002,a3,1x,i5,"
	    "\002-\002,a3,3x,\002(XTAL)\002,3x,2f10.4,f12.4)";
...
/*     ############################################################### */
/*     ##                                                           ## */
/*     ##  subroutine egauss3c  --  Gaussian vdw analysis via list  ## */
/*     ##                                                           ## */
/*     ############################################################### */
...
/*     ################################################################ */
/*     ##                                                            ## */
/*     ##  subroutine egauss3d  --  Gaussian analysis for smoothing  ## */
/*     ##                                                            ## */
/*     ################################################################ */
...
/*     interaction energy and partitions the energy among the atoms */
/*     for potential energy smoothing */


/* Subroutine */ int egauss3d_(void)
{
    /* Format strings */
    static char fmt_10[] = "(/,\002 Individual van der Waals\002,\002 Intera"
	    "ctions :\002,//,\002 Type\002,13x,\002Atom Names\002,18x,\002Min"
    ...
    static doublereal xi, yi, zi, xr, yr, zr;
    static integer iv14[25000];
    static doublereal eps, rdn, rad, rik;
    extern doublereal erf_(doublereal *);
    static doublereal rad2, rik2;
    static logical huge__;
    static doublereal fgrp, term, xred[25000], yred[25000], zred[25000];
    static logical usei;
    static doublereal width, broot, wterm;
    static logical header;
    static doublereal vscale[25000], expcut;
    ...
    /* Fortran I/O blocks */
    static cilist io___183 = { 0, 0, 0, fmt_10, 0 };
    static cilist io___185 = { 0, 0, 0, fmt_20, 0 };
