/* minrigid.f -- translated by f2c (version 20050501).
...
/*     ################################################################# */
/*     ##                                                             ## */
/*     ##  program minrigid  --  low store BFGS rigid body optimizer  ## */
/*     ##                                                             ## */
/*     ################################################################# */
...
{
    /* Format strings */
    static char fmt_30[] = "(/,\002 Enter RMS Gradient per Rigid Body Criter"
    ...
    static cilist io___23 = { 0, 0, 0, fmt_60, 0 };
...
/*     make the call to the optimization routine */
    ...
    lbfgs_(&nvar, xx, &minimum, &grdmin, (D_fp)minrigid1_, (U_fp)optsave_);
...
/*     ################################################################ */
/*     ##                                                            ## */
/*     ##  function minrigid1  --  energy and gradient for minrigid  ## */
/*     ##                                                            ## */
/*     ################################################################ */
...
doublereal minrigid1_(doublereal *xx, doublereal *g)
{
    /* System generated locals */
    integer i__1;
    doublereal ret_val;
...
/* Main program alias */ int minrigid_ () { MAIN__ (); return 0; }
