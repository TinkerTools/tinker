/* elj.f -- translated by f2c (version 20050501).
...
/* Subroutine */ int elj_(void)
{
    static doublereal elrc;
    extern /* Subroutine */ int elj0a_(void), elj0b_(void), elj0c_(void), 
	    elj0d_(void), elj0e_(void), evcorr_(doublereal *);
...
/*     ################################################################## */
/*     ##                                                              ## */
/*     ##  subroutine elj0a  --  double loop Lennard-Jones vdw energy  ## */
/*     ##                                                              ## */
/*     ################################################################## */
...
/*     ################################################################# */
/*     ##                                                             ## */
/*     ##  subroutine elj0b  --  Lennard-Jones vdw energy via lights  ## */
/*     ##                                                             ## */
/*     ################################################################# */
...
/* Subroutine */ int elj0c_(void)
{
    ...
    extern /* Subroutine */ int image_(doublereal *, doublereal *, doublereal 
	    *);
    static doublereal taper, vscale[25000];
    extern /* Subroutine */ int switch_(char *, ftnlen), groups_(logical *, 
	    doublereal *, integer *, integer *, integer *, integer *, integer 
	    *, integer *);
    static logical proceed;
...
/*     ################################################################ */
/*     ##                                                            ## */
/*     ##  subroutine elj0d  --  Lennard-Jones energy for smoothing  ## */
/*     ##                                                            ## */
/*     ################################################################ */
...
/*     ############################################################## */
/*     ##                                                          ## */
/*     ##  subroutine elj0e  --  Lennard-Jones energy for stophat  ## */
/*     ##                                                          ## */
/*     ############################################################## */
...
/* Subroutine */ int elj0e_(void)
{
    ...
    static integer iv14[25000];
    static doublereal rdn, rik, eps, rik2, rik3, rik4, rik5, rik6, fgrp, xred[
	    25000], yred[25000], zred[25000];
    static logical usei;
    static doublereal width, width2, width3, width4, width5, width6, vscale[
	    25000];
