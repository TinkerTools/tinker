/* eimptor3.f -- translated by f2c (version 20050501).
...
/* Subroutine */ int eimptor3_(void)
{
    /* Format strings */
    static char fmt_10[] = "(/,\002 Individual Improper Torsion\002,\002 Int"
	    "eractions :\002,//,\002 Type\002,23x,\002Atom Names\002,20x,\002"
	    "Angle\002,6x,\002Energy\002,/)";
    ...
    static doublereal xt, yt, zt, xu, yu, zu, rt2, ru2, rcb, xia, yia, zia, 
	    ...
	    ycb, xtu, ytu, ztu, zcb, xdc, ydc, zdc, phi1, phi2, phi3;
...
/*     increment the total torsional angle energy */
		...
		++action_1.neit;
		energi_1.eit += e;
		analyz_1.aeit[ib - 1] += e * .5;
		analyz_1.aeit[ic - 1] += e * .5;
