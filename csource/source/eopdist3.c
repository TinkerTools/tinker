/* eopdist3.f -- translated by f2c (version 20050501).
...
/* Subroutine */ int eopdist3_(void)
{
    /* Format strings */
    static char fmt_10[] = "(/,\002 Individual Out-of-Plane Distance\002,"
	    "\002 Interactions :\002,//,\002 Type\002,23x,\002Atom Names\002,"
	    "17x,\002Distance\002,6x,\002Energy\002,/)";
    static char fmt_20[] = "(\002 O-P-Dist\002,3x,i5,\002-\002,a3,3(1x,i5"
    ...
    static doublereal dt, xt, yt, zt, dt2, dt3, dt4, rt2, xia, yia, zia, xib, 
	    yib, zib, xic, yic, zic, xid, yid, zid, xad, yad, zad, xbd, ybd, 
