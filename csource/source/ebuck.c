/* ebuck.f -- translated by f2c (version 20050501).
...
/*     ############################################################# */
/*     ##                                                         ## */
/*     ##  subroutine ebuck  --  Buckingham van der Waals energy  ## */
/*     ##                                                         ## */
/*     ############################################################# */
...
/* Subroutine */ int ebuck_(void)
{
    /* Format strings */
    static char fmt_10[] = "(/,\002 EBUCK  --  Stophat Smoothing not Availab"
	    "le\002,\002 for Buckingham vdw Potential\002)";

    /* Builtin functions */
    integer s_wsfe(cilist *), e_wsfe(void);

    /* Local variables */
    static doublereal elrc;
    extern /* Subroutine */ int fatal_(void), evcorr_(doublereal *), ebuck0b_(
	    void), ebuck0d_(void), ebuck0c_(void), ebuck0a_(void);
...
/*     ################################################################# */
/*     ##                                                             ## */
/*     ##  subroutine ebuck0a  --  double loop Buckingham vdw energy  ## */
/*     ##                                                             ## */
/*     ################################################################# */
...
/* Subroutine */ int ebuck0a_(void)
{
    ...
    static doublereal rdn, rik, eps, rik2, rik3, rik4, rik5, fgrp, xred[25000]
...
/*     ################################################################ */
/*     ##                                                            ## */
/*     ##  subroutine ebuck0b  --  Buckingham vdw energy via lights  ## */
/*     ##                                                            ## */
/*     ################################################################ */
...
/* Subroutine */ int ebuck0b_(void)
{
    ...
    static doublereal eps, rdn, rik, rik2, rik3, rik4, rik5, fgrp, xred[25000]
	    , yred[25000];
    static integer stop;
...
/*     ############################################################## */
/*     ##                                                          ## */
/*     ##  subroutine ebuck0c  --  Buckingham vdw energy via list  ## */
/*     ##                                                          ## */
/*     ############################################################## */
...
/*     ############################################################### */
/*     ##                                                           ## */
/*     ##  subroutine ebuck0d  --  Buckingham energy for smoothing  ## */
/*     ##                                                           ## */
/*     ############################################################### */
...
/* Subroutine */ int ebuck0d_(void)
{
    extern /* Subroutine */ int egauss_(void);
