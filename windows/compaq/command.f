...
c
c     USE DFLIB is required to resolve the "getarg" call, and
c     USE DFPORT is needed to resolve the "iargc" function when
c     building with the Compaq Visual Fortran compiler
c
c
      subroutine command
      USE DFLIB
