...
zip nucleic.zip nucleic.exe
zip optimize.zip optimize.exe
zip optirot.zip optirot.exe
zip optrigid.zip optrigid.exe
zip path.zip path.exe
zip pdbxyz.zip pdbxyz.exe
zip polarize.zip polarize.exe
zip poledit.zip poledit.exe
zip potential.zip potential.exe
zip prmedit.zip prmedit.exe
zip protein.zip protein.exe
zip pss.zip pss.exe
zip pssrigid.zip pssrigid.exe
zip pssrot.zip pssrot.exe
zip radial.zip radial.exe
zip saddle.zip saddle.exe
zip scan.zip scan.exe
zip sniffer.zip sniffer.exe
...
zip vibrot.zip vibrot.exe
zip xtalfit.zip xtalfit.exe
