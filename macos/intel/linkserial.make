...
ifort -O3 -no-ipo -no-prec-div -static-intel -o arcedit.x arcedit.o libtinker.a ; strip arcedit.x
...
ifort -O3 -no-ipo -no-prec-div -static-intel -o critical.x critical.o libtinker.a ; strip critical.x
...
ifort -O3 -no-ipo -no-prec-div -static-intel -o mol2xyz.x mol2xyz.o libtinker.a ; strip mol2xyz.x
...
ifort -O3 -no-ipo -no-prec-div -static-intel -o testvir.x testvir.o libtinker.a ; strip testvir.x
...
ifort -O3 -no-ipo -no-prec-div -static-intel -o xyzmol2.x xyzmol2.o libtinker.a ; strip xyzmol2.x
