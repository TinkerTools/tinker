...
"settleg" modifies the gradient to remove components along any holonomic distance contraints for rigid three-site water using a variant of the SETTLE algorithm
...
"tcg_t0" applies T matrix to ind/p, and returns v3d/pT = 1/alpha + Tu
