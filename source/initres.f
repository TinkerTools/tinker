...
c
      data nn    /  416,  422,  428,  434,  440,  446,  452,  458,
     &              464,  470,  476,  484,  490,  496,  502,  508,
     &              514,  520,  526,  532,  538,  544,  550,  556,
     &              562,  568,  574,  580,  586,  592,  391,    0,
     &                0,    0,    0,  416 /
      data can   /  417,  423,  429,  435,  441,  447,  453,  459,
     &              465,  471,  477,  485,  491,  497,  503,  509,
     &              515,  521,  527,  533,  539,  545,  551,  557,
     &              563,  569,  575,  581,  587,  593,  392,    0,
     &              406,    0,    0,  417 /
      data cn    /  418,  424,  430,  436,  442,  448,  454,  460,
     &              466,  472,  478,  486,  492,  498,  504,  510,
     &              516,  522,  528,  534,  540,  546,  552,  558,
     &              564,  570,  576,  582,  588,  594,  393,  403,
     &              408,    0,    0,  418 /
      data hnn   /  419,  425,  431,  437,  443,  449,  455,  461,
     &              467,  473,  479,  487,  493,  499,  505,  511,
     &              517,  523,  529,  535,  541,  547,  553,  559,
     &              565,  571,  577,  583,  589,  595,  394,    0,
     &                0,    0,    0,  419 /
      data on    /  420,  426,  432,  438,  444,  450,  456,  462,
     &              468,  474,  480,  488,  494,  500,  506,  512,
     &              518,  524,  530,  536,  542,  548,  554,  560,
     &              566,  572,  578,  584,  590,  596,  395,  405,
     &              409,    0,    0,  420 /
      data han   /  421,  427,  433,  439,  445,  451,  457,  463,
     &              469,  475,  481,  489,  495,  501,  507,  513,
     &              519,  525,  531,  537,  543,  549,  555,  561,
     &              567,  573,  579,  585,  591,    0,  396,  404,
     &              407,    0,    0,  421 /
c
c     biopolymer types for C-terminal peptide backbone atoms
c
      data nc    /  597,  603,  609,  615,  621,  627,  633,  639,
     &              645,  651,  657,  662,  668,  674,  680,  686,
     &              692,  698,  704,  710,  716,  722,  728,  734,
     &              740,  746,  752,  758,  764,  770,    0,    0,
     &                0,  410,  412,  597 /
      data cac   /  598,  604,  610,  616,  622,  628,  634,  640,
     &              646,  652,  658,  663,  669,  675,  681,  687,
     &              693,  699,  705,  711,  717,  723,  729,  735,
     &              741,  747,  753,  759,  765,  771,    0,    0,
     &                0,    0,  414,  598 /
      data cc    /  599,  605,  611,  617,  623,  629,  635,  641,
     &              647,  653,  659,  664,  670,  676,  682,  688,
     &              694,  700,  706,  712,  718,  724,  730,  736,
     &              742,  748,  754,  760,  766,  772,    0,    0,
     &                0,    0,    0,  599 /
      data hnc   /  600,  606,  612,  618,  624,  630,  636,  642,
     &              648,  654,    0,  665,  671,  677,  683,  689,
     &              695,  701,  707,  713,  719,  725,  731,  737,
     &              743,  749,  755,  761,  767,  773,    0,    0,
     &                0,  411,  413,  600 /
      data oc    /  601,  607,  613,  619,  625,  631,  637,  643,
     &              649,  655,  660,  666,  672,  678,  684,  690,
     &              696,  702,  708,  714,  720,  726,  732,  738,
     &              744,  750,  756,  762,  768,  774,    0,    0,
     &                0,    0,    0,  601 /
      data hac   /  602,  608,  614,  620,  626,  632,  638,  644,
     &              650,  656,  661,  667,  673,  679,  685,  691,
     &              697,  703,  709,  715,  721,  727,  733,  739,
     &              745,  751,  757,  763,  769,    0,    0,    0,
     &                0,    0,  415,  602 /
c
