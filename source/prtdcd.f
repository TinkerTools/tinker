...
c     #################################################################
c     ##                                                             ##
c     ##  subroutine prtdcd2  --  output of DCD-format archive file  ##
c     ##                                                             ##
c     #################################################################
c
c
c     "prtdcd2" writes out a set of Cartesian coordinates to an
c     archive file in CHARMM DCD binary format compatible with the
c     VMD visualization software and other packages
c
c     note the format used is based on the "dcdplugin.c" code from
c     the NAMD and VMD programs, and tutorial 4.1 from the software
c     package GENESIS: Generalized-Ensemble Simulation System
