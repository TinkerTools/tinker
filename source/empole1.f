...
!$OMP& n14,i14,n15,i15,np11,ip11,np12,ip12,np13,ip13,np14,ip14,REnvlst,
!$OMP& REvlst,cut2,REmpolecut2,aewald,aesq2,aesq2n,poltyp,ntpair,tindex,
!$OMP& tdipdip,toffset,toffset0,field,fieldp,fieldt,fieldtp,maxlocal)
