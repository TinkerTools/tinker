...
c
      ...
      maxnd = max(2000,maxnd+100)
      maxnd5 = max(500,maxnd5+100)
      maxnd4 = max(500,maxnd4+100)
      maxnd3 = max(500,maxnd3+100)
      maxnmp = max(2000,maxnmp+100)
      maxncfb = max(2000,maxncfb+100)
      maxncfa = max(2000,maxncfa+100)
