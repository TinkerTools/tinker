...
c
  ...
  160 format (/,' Number of Frames for Diffusion Calculation :',i13)
c
...
c
      write (iout,170)
  170 format (/,' Reading the Coordinates Archive File :',/)
      nframe = 0
      iframe = start
      skip = start
