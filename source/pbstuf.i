...
c     ################################################################
c     ##                                                            ##
c     ##  pbstuf.i  --  parameters for Poisson-Boltzmann solvation  ##
c     ##                                                            ##
c     ################################################################
c
c
...
c     but there is only have theory for energies (no gradients)
c
...
c
      ...
      common /pbstuf/ pbe,apbe(maxatm),pbr(maxatm),pbep(3,maxatm),
     &                pbfp(3,maxatm),pbtp(3,maxatm),pbeuind(3,maxatm),
     &                pbeuinp(3,maxatm),grid(3),gcent(3),cgrid(3),
     &                cgcent(3),fgrid(3),fgcent(3),ionr(maxion),
     &                ionc(maxion),pdie,sdie,srad,swin,sdens,smin,ionn,
     &                dime(3),ionq(maxion),pbtyp,pbsoln,bcfl,srfm,chgm
