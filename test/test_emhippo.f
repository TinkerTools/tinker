...
c
     ...
     &                       'emhippo_ewald',1.0d-4,1.0d-4,1.0d-3)
      return
      end
c
c
...
c
     ...
     &                       'emhippo_nonewald',1.0d-4,1.0d-4,
     &                       1.0d-3)
      return
      end
c
...
c
c
      subroutine test_emhippo_case (key,reffile,tname,
     &                              eps_e,eps_g,eps_v)
      use action
      use atoms
      use energi
...
c
      ...
      call assert_real (em,refeng,eps_e,tpre//tname//' mpole (v0)')
c
